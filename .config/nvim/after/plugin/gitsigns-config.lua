require('gitsigns').setup {
  ...
  on_attach                    = function(bufnr)
    ...
    -- Actions
    map('n', '<leader>vgs', gs.stage_hunk)
    map('n', '<leader>vgr', gs.reset_hunk)
    map('v', '<leader>vgs', function() gs.stage_hunk { vim.fn.line('.'), vim.fn.line('v') } end)
    map('v', '<leader>vgr', function() gs.reset_hunk { vim.fn.line('.'), vim.fn.line('v') } end)
